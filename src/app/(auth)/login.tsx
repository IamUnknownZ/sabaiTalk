    ...
    <Screen scroll contentStyle={styles.screen}>
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Log in to continue discovering people nearby.</Text>
        </View>
        ...
        <View style={styles.actions}>
          ...
          <View style={styles.alternateRow}>
            ...
            <Pressable accessibilityRole="button" onPress={() => router.push('/(auth)/register')} hitSlop={8}>
              <Text style={styles.alternateLink}>Create account</Text>
            </Pressable>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: colors.textMuted, fontSize: typography.body, lineHeight: 22, maxWidth: 360 },
